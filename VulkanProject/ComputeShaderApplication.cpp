...
{
    auto vertShaderCode = readFile("../shader/particlev.spv");
    auto fragShaderCode = readFile("../shader/particlef.spv");
...
{
    auto computeShaderCode = readFile("../shader/compute.spv");
...
{
    VkDeviceSize bufferSize = sizeof(UBObject);
...
void ComputeShaderApplication::createComputeDescriptorSets()
{
    ...
    for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
        ...
        uniformBufferInfo.range = sizeof(UBObject);
